...
for i in range(len(p_l_taus_1)):
    ...
    (reward_m_fix_1, tau_m_fix_1, knowledge_m_fix_1, exploration_m_fix_1) = perform_experiments(N_bandits, N_experiments, N_episodes, tau=p_l_taus_1[i]/N_bandits, shock_prob=shock_prob_1, tau_strategy="stable")
        
    exploration_prob_fix_1= np.count_nonzero(exploration_m_fix_1, axis=1)/N_episodes
...
for i in range(len(p_l_taus_1)):
    ...
    (reward_m_acc_1, tau_m_acc_1, knowledge_m_acc_1, exploration_m_acc_1) = perform_experiments(N_bandits, N_experiments, N_episodes, tau=p_l_taus_1[i]/N_bandits, shock_prob=shock_prob_1, tau_strategy="accumulated resources")
        
    exploration_prob_acc_1= np.count_nonzero(exploration_m_acc_1, axis=1)/N_episodes
